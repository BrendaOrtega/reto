...
class Why extends Component {
    ...
    render() {
        return (
            <div className="why">
                <h2 className="bot">¿PORQUE RETO MÉXICO?</h2>
                <p className="bot">Nuestro proceso de innovación abierta basado en retos le permite
                ...
                <button className="btn_mas bot">Conoce más</button>
                <br/>
                <img className="bot" src={iconos} alt=""/>
            </div>
        );
    }
}
